  ...
  return (
    <div className="flex flex-col top-0 left-0 h-auto w-0 sm:w-32 md:w-48 bg-bank-black overflow-auto">
      <div className="flex flex-col w-4/5 h-4/5 self-center mt-32">
        ...
        <SidebarItem icon={<AiFillBank color="white" size='20'/>} item={"Accounts"} content={"Account"}/>
...
const SidebarItem = ({ icon, item, content }: { icon: any, item: string, content: string }) => (
  ...
  <button data-modal-target={content} data-modal-toggle={content} className="block text-white bg-black-700 hover:bg-black-800 focus:ring-4 focus:outline-none focus:ring-black-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-black-600 dark:hover:bg-purple-700 dark:focus:ring-purple-800" type="button">
    {icon}
