...
var UserController = /** @class */ (function (_super) {
    ...
    UserController.prototype.getRepository = function () {
        return data_source_1.AppDataSource.getRepository(user_entity_1.User);
    };
    UserController.prototype.getAccounts = function (user_id) {
                ...
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, accountRepository
                                ...
                                .where("account.user_id = :user_id", { user_id: user_id })
                                .getMany()];
                    case 3:
                        accounts = _a.sent();
    ...
    UserController.prototype.getUser = function (username, password) {
        return __awaiter(this, void 0, void 0, function () {
            var user;
            return __generator(this, function (_a) {
                switch (_a.label) {
